...
# Local strings
PROJECT_NAME = "Ateneu Barcelonès Nord"
...
ALLOWED_HOSTS = ['serveis.ateneubnord.cat', 'localhost',]
USE_X_FORWARDED_HOST = True

# Wasabi cloud storage configuration
AWS_ACCESS_KEY_ID = 'ZTQQIR6YB9B7WH324FMB'
AWS_SECRET_ACCESS_KEY = 'BleYNZEzMCoeYoblAdETCrYmdyTt97C4pszcKNeK'
AWS_STORAGE_BUCKET_NAME = 'ateneus-bnord'
...
EMAIL_HOST = 'ateneubnord-cat.correoseguro.dinaserver.com'
EMAIL_PORT = 465
EMAIL_HOST_USER = 'coordinacio@ateneubnord.cat'
EMAIL_HOST_PASSWORD = 'cantiranasi'
EMAIL_USE_TLS = False
EMAIL_USE_SSL = True
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
DEFAULT_FROM_EMAIL = 'coordinacio@ateneubnord.cat'
