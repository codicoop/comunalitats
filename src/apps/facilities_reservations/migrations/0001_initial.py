    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default='#e94e1b', help_text="Qualsevol color CSS vàlid, incloent-hi 'red', 'green', etc.", max_length=7, verbose_name='color al calendari')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.CharField(blank=True, help_text="En cas d'indicar-se, l'esdeveniment del calendari podrà clicar-se i portarà cap a aquest enllaç.", max_length=250, null=True, verbose_name='enllaç web')),
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reservations', to='facilities_reservations.room', verbose_name='sala')),
            ],
            options={
