# Generated by Django 3.2.14 on 2024-07-18 13:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='activity',
            name='course',
            field=models.ForeignKey(help_text="Escriu el nom de l'acció i selecciona-la del desplegable. Si no existeix, clica a la lupa i després a 'Crear acció'.", on_delete=django.db.models.deletion.CASCADE, related_name='activities', to='cc_courses.course', verbose_name="Projecte al qual s'engloba"),
        ),
        migrations.AlterField(
            model_name='activity',
            name='date_start',
