    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('town', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='towns.town', verbose_name='municipi')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('town', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='towns.town', verbose_name='població')),
            ],
            options={
                'verbose_name': 'lloc',
                'ordering': ['name'],
