...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('projects', '0005_auto_20240709_1020'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='course',
            field=models.ForeignKey(help_text="Escriu el nom del projecte i selecciona'l del desplegable. Si no existeix, clica a la lupa i després a 'Crear projecte'.", null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='stage_activities', to='cc_courses.course', verbose_name="Projecte al qual s'engloba"),
        ),
        ...
        migrations.AlterField(
            model_name='project',
            name='description',
            field=models.TextField(blank=True, null=True, verbose_name='descripció actuació'),
        ),
        migrations.AlterField(
            model_name='project',
            name='name',
            field=models.CharField(max_length=200, unique=True, verbose_name="nom de l'actuació"),
        ),
        migrations.AlterField(
            model_name='project',
            name='town',
