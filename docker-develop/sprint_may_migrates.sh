...
docker exec develop_coopolis_app python manage.py migrate mailing_manager
...
docker exec develop_coopolis_segon_ateneu python manage.py migrate mailing_manager
