...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.FileField(blank=True, max_length=250, null=True, upload_to=coopolis.models.stage_signatures_upload_path, verbose_name='certificat'),
        ),
        ...
        migrations.AlterField(
            ...
            field=models.FileField(blank=True, max_length=250, null=True, upload_to=coopolis.models.stage_certificate_upload_path, verbose_name='fitxa de projectes (document amb signatures)'),
        ),
    ]
